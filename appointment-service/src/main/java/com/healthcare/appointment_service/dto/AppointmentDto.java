...
public record AppointmentDto(String id, String appointmentDate, String appointmentTime,
    ...
    public static AppointmentDto fromAppointment(Appointment response){
        return new AppointmentDto(response.getId(), response.getAppointmentDate(), response.getAppointmentTime(),
                String.valueOf(response.getPatientId()), response.getPatientName(),
